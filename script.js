...
pierre.addEventListener("click", function () {
  ...
  if (computerChoice == 'pierre') {
    ...
    computerImage.setAttribute("src", "https://zupimages.net/up/21/37/psjg.png");
    ...
    computerImage.setAttribute("src", "https://zupimages.net/up/21/37/w2sp.png");
    computerImage.setAttribute("alt", "imagecomputer");
    document.body.appendChild(computerImage);
    ...
    computerImage.setAttribute("src", "https://zupimages.net/up/21/37/w17g.png");
    computerImage.setAttribute("alt", "imagecomputer");
    document.body.appendChild(computerImage);
